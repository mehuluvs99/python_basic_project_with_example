...
in Python. The objects stored in both sequences can have different data types.
...
The key difference between the two is that while lists are mutable, tuples on
the other hand are immutable objects. 
...
.pyc files are not created for all the files that you run.
